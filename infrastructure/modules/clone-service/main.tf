...
resource "aws_apigatewayv2_integration" "lambda_integration" {
  ...
  integration_uri  = aws_lambda_function.voice_clone_handler.invoke_arn
...
resource "aws_lambda_permission" "allow_api_gateway" {
  ...
  function_name = aws_lambda_function.voice_clone_handler.function_name
